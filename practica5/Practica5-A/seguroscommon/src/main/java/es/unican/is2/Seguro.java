...
public class Seguro {
	...
	public class PotenciaInvalidaException extends RuntimeException {
		public PotenciaInvalidaException(String message) {
			super(message);
		}
	}
	 ...
	 * @throws NullPointerException si la fecha de inicio o la cobertura del seguro son null
	 * @throws PotenciaInvalidaException si la potencia del coche es menor o igual a 0
     */
	public double precio() {
		...
		if (potencia <= 0) {
			throw new PotenciaInvalidaException("La potencia debe ser un valor positivo");
		}

        // Si aún no ha empezado el seguro, precio = 0
        if (LocalDate.now().isBefore(fechaInicio)) return 0;
        ...
        // Incremento por potencia del coche
